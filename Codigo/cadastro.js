...
let labelConfirmsenha =document.querySelector('#confirmsenha')
...
function cadastrar()
{
  if (validNome && validSenha && validEmail &&  validConfirmsenha){
    ...
    msgError.innerHTML = '<strong> Há campos sem preenchimento. </strong>'
